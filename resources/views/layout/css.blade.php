...
<link rel="stylesheet" href="{{secure_asset('lte/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
<!-- iCheck -->
...
<!-- summernote -->
<link rel="stylesheet" href="{{secure_asset('lte/plugins/summernote/summernote-bs4.css')}}">
